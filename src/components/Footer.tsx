...
export function Footer() {
  return (
    <section id="contato" className="relative w-full min-h-dvh pt-32 pb-8 overflow-hidden bg-background flex flex-col">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
         <div className="absolute inset-0 bg-black/50 z-10 pointer-events-none" />
         <Image src="/assets/Footer.png" alt="Footer Background" fill className="object-cover object-bottom" />
      </div>
      ...
      <Container className="relative z-20 flex-1 flex flex-col items-center justify-between w-full h-full">
        <ScrollReveal className="flex flex-col items-center mt-auto">
          ...
          <p className="text-white font-sans text-center max-w-2xl mb-12 text-sm md:text-base leading-relaxed drop-shadow-lg">
            Está pronto para dar o próximo passo no seu negócio ou projeto? Fique à vontade
            para me chamar e ver como eu posso ajudar. Adoraria bater um papo.
          </p>
        </ScrollReveal>
        
        <ScrollReveal delay={200} className="w-full flex flex-wrap items-center justify-center gap-4 mb-24">
        ...
        <div className="w-full mt-auto border-t border-white/20 pt-8 flex flex-col md:flex-row items-center justify-between text-[10px] sm:text-xs text-white/70 font-sans gap-4 pb-4">
           ...
           <span className="text-center">Desenvolvido e desenhado por Paulo Dias. Todos os direitos reservados.</span>
